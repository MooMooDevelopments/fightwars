  ...
  private renderKeybindSettings() {
    return html`
      ...
      <setting-keybind
        ...
        defaultKey=${this.defaultKeybinds.buildArtillery}
        .value=${this.getKeyValue("buildArtillery")}
        .display=${this.getKeyChar("buildArtillery")}
        @change=${this.handleKeybindChange}
      ></setting-keybind>
      ...
      <setting-keybind
        ...
        defaultKey=${this.defaultKeybinds.buildSubmarine}
        .value=${this.getKeyValue("buildSubmarine")}
        .display=${this.getKeyChar("buildSubmarine")}
        @change=${this.handleKeybindChange}
      ></setting-keybind>

      <setting-keybind
        action="buildCarrier"
        label=${translateText("user_setting.build_carrier")}
        description=${translateText("user_setting.build_carrier_desc")}
        defaultKey=${this.defaultKeybinds.buildCarrier}
        .value=${this.getKeyValue("buildCarrier")}
        .display=${this.getKeyChar("buildCarrier")}
        @change=${this.handleKeybindChange}
      ></setting-keybind>
