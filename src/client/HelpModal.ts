            ...
            <div class="pt-2 pb-4 px-4 overflow-x-auto">
              <table class="w-full text-sm border-separate border-spacing-y-1">
                ...
                <tbody class="text-white/80">
                  ...
                  <tr class="hover:bg-white/5 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5">
                      ${this.renderKey(keybinds.setRallyPoint)}
                    </td>
                    <td class="py-3 border-b border-white/5 text-white/70">
                      ${translateText("user_setting.set_rally_point_desc")}
                    </td>
                  </tr>
                  <tr class="hover:bg-white/5 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5">
            ...
            <div class="overflow-hidden rounded-xl border border-white/10">
              <table class="w-full border-collapse">
                ...
                <tbody class="text-white/80">
                  ...
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                      ${translateText("unit_type.artillery")}
                    </td>
                    <td class="py-3 border-b border-white/5">
                      <img
                        src=${assetUrl("images/ArtilleryIconWhite.svg")}
                        class="w-8 h-8 scale-75 origin-left"
                      />
                    </td>
                    <td
                      class="py-3 border-b border-white/5 text-white/60 text-sm"
                    >
                      ${translateText("help_modal.build_artillery_desc")}
                    </td>
                  </tr>
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                      ${translateText("unit_type.radar")}
                    </td>
                    <td class="py-3 border-b border-white/5">
                      <img
                        src=${assetUrl("images/RadarIconWhite.svg")}
                        class="w-8 h-8 scale-75 origin-left"
                      />
                    </td>
                    <td
                      class="py-3 border-b border-white/5 text-white/60 text-sm"
                    >
                      ${translateText("help_modal.build_radar_desc")}
                    </td>
                  </tr>
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                  ...
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                      ${translateText("unit_type.carrier")}
                    </td>
                    <td class="py-3 border-b border-white/5">
                      <img
                  ...
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                      ${translateText("unit_type.submarine")}
                    </td>
                    <td class="py-3 border-b border-white/5">
                      <img
                        src=${assetUrl("images/SubmarineIconWhite.svg")}
                        class="w-8 h-8 scale-75 origin-left"
                      />
                    </td>
                    <td
                      class="py-3 border-b border-white/5 text-white/60 text-sm"
                    >
                      ${translateText("help_modal.build_submarine_desc")}
                    </td>
                  </tr>
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                      ${translateText("unit_type.paratrooper")}
                    </td>
                    <td class="py-3 border-b border-white/5">
                      <img
                        src=${assetUrl("images/ParatrooperIconWhite.svg")}
                        class="w-8 h-8 scale-75 origin-left"
                      />
                    </td>
                    <td
                      class="py-3 border-b border-white/5 text-white/60 text-sm"
                    >
                      ${translateText("help_modal.build_paratrooper_desc")}
                    </td>
                  </tr>
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
                      ${translateText("unit_type.bomber")}
                    </td>
                    <td class="py-3 border-b border-white/5">
                      <img
                        src=${assetUrl("images/BomberIconWhite.svg")}
                        class="w-8 h-8 scale-75 origin-left"
                      />
                    </td>
                    <td
                      class="py-3 border-b border-white/5 text-white/60 text-sm"
                    >
                      ${translateText("help_modal.build_bomber_desc")}
                    </td>
                  </tr>
                  <tr class="bg-white/5 hover:bg-white/10 transition-colors">
                    <td class="py-3 ps-4 border-b border-white/5 font-medium">
