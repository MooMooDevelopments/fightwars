        ...
        <div class="relative">
          ...
          <button
            class="absolute -top-3 -right-3 w-7 h-7 flex items-center justify-center
                    bg-white/10 hover:bg-status-loss text-white rounded-full shadow-sm transition-colors z-10004"
          ...
          <div
            class="bg-surface-deep/95 p-2 sm:p-3 rounded-[10px] z-10003 shadow-2xl shadow-black/50 ring-1 ring-white/5
                ...
                (emoji) => html`
                  <button
                    class="flex items-center justify-center cursor-pointer aspect-square
                           border border-solid border-white/20 rounded-lg bg-surface hover:bg-white/10 active:bg-white/20
