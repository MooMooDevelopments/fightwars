      ...
      >
        ...
        >
          ...
          >
            ...
            ${BRAND.community.redditUrl
              ? html`<a
                  href=${BRAND.community.redditUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  class="opacity-60 hover:opacity-100 hover:scale-110 transition-all"
                >
            ...
            ${BRAND.community.discordUrl
              ...
              : nothing}
            ${BRAND.community.wikiUrl
              ? html`<a
                  href=${BRAND.community.wikiUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  class="opacity-60 hover:opacity-100 hover:scale-110 transition-all"
                >
          ...
          >
            ...
            ></a>
            <!-- Upstream attribution: AGPL §7 requires this notice to stay
                 visible, and §13 the link to our source. Both read from
                 BRAND so they are never edited away by a rebrand. -->
            <span>${BRAND.upstream.copyright}</span>
            <a
