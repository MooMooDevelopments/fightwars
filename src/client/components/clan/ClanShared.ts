  ...
  const input = html`
    <div class="relative w-full sm:flex-1 sm:min-w-0">
      <input
        ...
        .value=${value}
        @input=${onInput}
        class="w-full h-10 pl-10 pr-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/20 focus:outline-none focus:ring-2 focus:ring-action/50 focus:border-action/50 transition-all font-medium hover:bg-white/10 text-sm"
  ...
  return html`
    <div class="flex items-center gap-2 shrink-0">
      ...
      <button
        ...
        class="h-10 w-10 shrink-0 flex items-center justify-center bg-white/5 border border-white/10 rounded-xl text-white/70 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-action/50 focus:border-action/50 transition-all"
      >
        ...
        ${perPageOptions.map(
          (opt) => html`
            <button
              ...
              class="px-2 py-1 text-xs font-bold rounded-lg transition-all
                ${membersPerPage === opt
                ? "bg-action/15 text-action-ink border border-action/30"
