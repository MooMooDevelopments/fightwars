    ...
    if (!isMember && this.myPublicId === null) {
      ...
      buttons.push(html`
        <button
          ...
          class="flex-1 px-6 py-3 text-sm font-bold text-white uppercase tracking-wider bg-action hover:bg-action-hover active:bg-action/80 rounded-xl transition-all"
        >
      ...
      buttons.push(html`
        <button
          ...
          class="flex-1 px-6 py-3 text-sm font-bold text-white uppercase tracking-wider bg-action hover:bg-action-hover active:bg-action/80 rounded-xl transition-all disabled:opacity-50 disabled:pointer-events-none"
        >
