            ...
            <table class="w-full text-sm border-collapse table-fixed">
              ...
              <tbody>
                ${sorted.map((clan, index) => {
                  ...
                  const rankColor =
                    displayRank === 1
                      ? "text-rank-gold bg-rank-gold/10 ring-1 ring-rank-gold/20"
                      : displayRank === 2
                        ? "text-rank-silver bg-rank-silver/10 ring-1 ring-rank-silver/20"
                        : displayRank === 3
                          ? "text-rank-bronze bg-rank-bronze/10 ring-1 ring-rank-bronze/20"
                  ...
                  return html`
                    ...
                    >
                      ...
                      <td class="py-3 px-4 font-bold text-action-ink">
                        <div
                          class="px-2.5 py-1 rounded bg-action/10 border border-action-ink/20 inline-block"
                        >
                          ${clan.clanTag}
                        </div>
                      </td>
                      ...
                      <td
                        class="py-3 px-4 text-right font-mono text-status-gain/90"
                      >
                      ...
                      <td
                        class="py-3 px-4 text-right font-mono text-status-loss/90"
                      >
