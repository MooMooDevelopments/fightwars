          ...
          >
            ...
            <ol class="flex flex-col gap-3 text-sm text-slate-200">
              <li class="flex items-start gap-3">
                <span
                  class="shrink-0 w-6 h-6 rounded-full bg-action flex items-center justify-center text-white font-bold text-xs"
                  >1</span
                >
            ...
            <button
              class="w-full py-2.5 rounded-lg bg-action hover:bg-action-hover active:bg-action/80 text-white font-semibold transition-colors"
              @click=${this.closeGuide}
            >
      ...
      >
        <div class="flex gap-3 items-center">
          <svg
            ...
            class="shrink-0 w-8 h-8 text-action-ink"
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            stroke-width="2"
        ...
        <div class="flex flex-col gap-1.5">
          <button
            class="w-full py-1.5 rounded-lg bg-action hover:bg-action-hover active:bg-action/80 text-white font-semibold text-sm transition-colors"
