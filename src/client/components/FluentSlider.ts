    ...
    return html`
      ...
      >
        <input
          ...
          style="background: linear-gradient(to right, var(--color-action) 0%, var(--color-action) ${percentage}%, rgba(255, 255, 255, 0.15) ${percentage}%, rgba(255, 255, 255, 0.15) 100%); background-size: 100% 6px; background-repeat: no-repeat; background-position: center; border-radius: 9999px;"
