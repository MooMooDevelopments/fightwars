 ...
 * new palette. Every file is generated by scripts/generatePalettes.ts; the
 * three dichromat palettes are laid out in the colour space of that
 * deficiency rather than being one "colorblind mode" that compromises
 * between all of them.
 *
 * `colorblind` was the single earlier name; UserSettings maps it to
 * `deuteranopia` (the most common deficiency) when reading stored settings.
 */
