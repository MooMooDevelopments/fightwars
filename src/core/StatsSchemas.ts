...
export const bombUnits = ["abomb", "hbomb", "mirv", "mirvw", "bombr"] as const;
...
export const GOLD_INDEX_UPKEEP = 6; // Gold paid out as upkeep (FightWars, brief §6.3)
