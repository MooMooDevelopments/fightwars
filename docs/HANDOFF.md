...
| 6.4 Military breadth, nuke consequences                    | **Nuke consequences done (session 11)** — `docs/MECHANICS.md` §04 A–C. Artillery and Radar built (session 12, §04 D–E, levers `--no-artillery`, `--no-radar`); four units to go — §03 7.1 has the 25-file checklist and §04 D–E the hooks.                                                                                                                                                                                                                                                                                                                                                 |
