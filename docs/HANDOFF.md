...
| 6.4 Military breadth, nuke consequences                    | **Nuke consequences done (session 11)** — `docs/MECHANICS.md` §04 A–C. Artillery built (session 12, §04 D, lever `--no-artillery`); five units to go — §03 7.1 has the 25-file checklist and §04 D–E the hooks.                                                                                                                                                                                                                                                                                                                                                                            |
