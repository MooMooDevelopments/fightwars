...
| 6.3 Materials, Manpower, upkeep, blockades, embargo price  | **In progress (session 11): upkeep and materials done** (`docs/MECHANICS.md` §01 "Upkeep", §03 7.2). Blockades and the embargo price next; Manpower already exists as `maxTroops` and should be surfaced, not duplicated.                                                                                                                                                                           |
